...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">View Logs</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="viewaddLogs.php">Add Logs</a></li>
      <li><a href="vieweditLogs.php">Edit Logs</a></li>
    </ul>
  </div>
</nav>
			...
			<div class="col-md-12">
				...
				<!-- 	<div class="nav-tabs-custom">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active"><a href="#tab1" data-toggle="tab">Add Logs</a></li>
							<li><a href="#tab2" data-toggle="tab">Edit Logs</a></li>
	                     </ul>
					</div> -->
					...
					<div>
						...
						<form class="form-inline" method="post" name="form1" action="javascript:;" style="padding: 25px;
						...
						<script type="text/javascript">
						    ...
						    function OnFindTab1(){
								//alert("hiee");
								document.form1.action = "viewaddLogs.php?#tab1";
											...
											<tbody>
												...
												?>
															<tr style="color:<?php echo $color; ?>">
																...
																<td>
																	<?php 
																		echo "<span style='font-weight:bold'>API:</span> " . 
																		urldecode($result->attributes()->user);
		                                              ...
		                                              ?>
																...
																<td>
																	<?php 
																		echo "<span style='font-weight:bold'>Error Code:</span> " .
																		 $result->response->attributes()->errCode;
